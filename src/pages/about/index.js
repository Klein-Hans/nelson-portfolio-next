      ...
      <div className="container mx-auto w-full h-full ">
        <div className="relative wrap overflow-hidden p-10 h-full">
          ...
          {careers.map((item, index) => {
            const { jobTitle, employer, description, startDate, endDate } = item.attributes;
            ...
            return (
              ...
              >
                ...
                <WorkExperience className={`${isEven ? "bg-gray-400" : "bg-primary-800"}`}>
                  <h3 className="font-bold uppercase text-gray-800 text-lg">{jobTitle}</h3>
                  <h4 className="uppercase text-gray-700 text-sm">{employer}</h4>
